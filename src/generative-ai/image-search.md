...
With AI image search on, the model you chose describes what is in the photo, and the store searches for those keywords, so it recognizes far more kinds of products. With it off, the photo is still recognized, but by a simpler model that runs in the shopper's browser and knows fewer things.
...
4. Go to **Configure >> Magic AI >> Storefront Features**. If your store has more than one channel, choose the channel at the top of the page.
...
2. The photo is analyzed and the search results page opens with the products that match what was found in it.
