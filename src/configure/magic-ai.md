...
Bagisto's generative AI features are branded **Magic AI** in the admin, and they are all configured in one place: **Configure >> Magic AI**. The group has four pages, listed on the left: **General**, **Providers**, **Admin Features** and **Storefront Features**.
...
1. Open the **Admin Features** page.
