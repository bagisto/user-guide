...
<ImagePopup src="/images/configure/shipping-methods.png" alt="Shipping Methods Configuration" />

After making changes, click on the **Save Configuration** button.

### Shipping Method Frontend

<ImagePopup src="/images/configure/shipping-output.png" alt="Shipping Methods Frontend View" />
