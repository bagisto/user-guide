...
<img src="/images/multi-vendor-marketplace/1-configuration.webp" alt="Customer Email and Password" />

Select the required channel and locale, update the settings accordingly, and then continue with the RMA process.

<img src="/images/multi-vendor-marketplace/2-rma-settings.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/3-rma-requests.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/4-rma-reason.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/5-rma-reason-creation.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/6-rma-rules.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/8-rma-statuses.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/9-rma-status-color.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/11-rma-custom-fields.webp" alt="Customer Email and Password" />

### Seller RMA Management

Sellers can view all RMA requests generated by customers or guests from the RMA section.

<img src="/images/multi-vendor-marketplace/12-rma-request.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/13-seller-rma-request-view.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/14-rma-view-status.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/15-rma-request-accept.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/18-customer-rma.webp" alt="Customer Email and Password" />

**Step 2:** Click on the Create Return Request button to start a new RMA request.

<img src="/images/multi-vendor-marketplace/19-customer-rma-create.webp" alt="Customer Email and Password" />

**Step 3:** Select the **Order ID** and click on the **Action icon** to proceed with the return or cancellation request.

<img src="/images/multi-vendor-marketplace/20-create-rma-process.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/21-rma-creation.webp" alt="Customer Email and Password" />

Once the RMA request is submitted, it will be visible in the RMA section for further tracking and updates.

<img src="/images/multi-vendor-marketplace/22-rma-list.webp" alt="Customer Email and Password" />
...
<img src="/images/multi-vendor-marketplace/23-guest-login.webp" alt="Customer Email and Password" />

Guests can log in by clicking the **Login Here** button and entering their **email address** and **Order ID**.

<img src="/images/multi-vendor-marketplace/24-guest-login-page.webp" alt="Customer Email and Password" />

After signing in, the guest will be redirected to the **RMA request page**.

<img src="/images/multi-vendor-marketplace/25-guest-rma.webp" alt="Customer Email and Password" />
