...
### Steps To Create A Bundle Product In Bagisto 2.3.0
...
4. Click the **Save Button**.
    ...
    ![Bundle](../../assets/2.3.0/images/bundle-product/bundle.png)
...
- **Tax Category:** Select the Tax Category from the dropdown list.
    ...
    ![editProduct](../../assets/2.3.0/images/bundle-product/editProduct.png)
...
- Enable the toggle button to allow guest customers to order the product.
    ...
    ![toggleButtons](../../assets/2.3.0/images/bundle-product/toggleButtons.png)
...
- **Description:** Mention your product in detail.
    ...
    ![description](../../assets/2.3.0/images/bundle-product/description.png)
...
- **Meta Description:** Enter a description for better search engine listings.
    ...
    ![metaDescription](../../assets/2.3.0/images/bundle-product/metaDescription.png)

### Images

To add product images, click on **Add Images**. You can add multiple images for your product.

![image](../../assets/2.3.0/images/bundle-product/image.png)
...
![options](../../assets/2.3.0/images/bundle-product/options.png)
...
![bundleOptions](../../assets/2.3.0/images/bundle-product/bundleOptions.png)

### Product At Front End

The bundle product will be visible at the front end.

![output](../../assets/2.3.0/images/bundle-product/output.png)
