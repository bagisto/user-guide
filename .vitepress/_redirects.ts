export const redirects = {
    ...
    '/2.3.0/product-types/bundle.html': '/product-types/bundle-product',
    ...
    '/2.3.0/marketing/communications.html#events': '/marketing/events',
    ...
    '/2.3.0/settings/inventory-source.html': '/settings/inventory-source',
    ...
    '/2.3.0/configure/design.html': '/configure/design',
    '/2.3.0/configure/back-orders.html': '/configure/back-orders',
    '/2.3.0/configure/guest-checkout.html': '/configure/guest-checkout',
    '/2.3.0/configure/product-view-page.html': '/configure/product-view-page',
    '/2.3.0/configure/cart-view-page.html': '/configure/cart-view-page',
    '/2.3.0/configure/frontend.html': '/configure/frontend',
    ...
    '/2.3.0/multi-vendor-marketplace/product-management.html': '/multi-vendor-marketplace/product-management',
    '/2.3.0/multi-vendor-marketplace/rating-management.html': '/multi-vendor-marketplace/rating-management',
    '/2.3.0/multi-vendor-marketplace/payment-management.html': '/multi-vendor-marketplace/payment-management',
    ...
    '/2.2.0/product-types/bundle.html': '/product-types/bundle-product',
    ...
    '/2.2.0/orders/refunds.html': '/orders/create-refunds',
    ...
    '/2.2.0/marketing/communications.html#events': '/marketing/events',
    ...
    '/2.2.0/settings/inventory-source.html': '/settings/inventory-source',
    ...
    '/2.2.0/configure/design.html': '/configure/design',
    '/2.2.0/configure/back-orders.html': '/configure/back-orders',
    '/2.2.0/configure/guest-checkout.html': '/configure/guest-checkout',
    '/2.2.0/configure/product-view-page.html': '/configure/product-view-page',
    '/2.2.0/configure/cart-view-page.html': '/configure/cart-view-page',
    '/2.2.0/configure/frontend.html': '/configure/frontend',
    ...
    '/2.1.0/product-types/bundle.html': '/product-types/bundle-product',
    ...
    '/2.1.0/marketing/communications.html#events': '/marketing/events',
    ...
    '/2.1.0/settings/inventory-source.html': '/settings/inventory-source',
    ...
    '/2.1.0/configure/design.html': '/configure/design',
    '/2.1.0/configure/back-orders.html': '/configure/back-orders',
    '/2.1.0/configure/guest-checkout.html': '/configure/guest-checkout',
    '/2.1.0/configure/product-view-page.html': '/configure/product-view-page',
    '/2.1.0/configure/cart-view-page.html': '/configure/cart-view-page',
    '/2.1.0/configure/frontend.html': '/configure/frontend',
    ...
    '/2.0/product-types/bundle.html': '/product-types/bundle-product',
    ...
    '/2.0/orders/refunds.html': '/orders/create-refunds',
    ...
    '/2.0/marketing/communications.html#events': '/marketing/events',
    ...
    '/2.0/settings/inventory-source.html': '/settings/inventory-source',
    ...
    '/2.0/configure/design.html': '/configure/design',
    '/2.0/configure/back-orders.html': '/configure/back-orders',
    '/2.0/configure/guest-checkout.html': '/configure/guest-checkout',
    '/2.0/configure/product-view-page.html': '/configure/product-view-page',
    '/2.0/configure/cart-view-page.html': '/configure/cart-view-page',
    '/2.0/configure/frontend.html': '/configure/frontend',
